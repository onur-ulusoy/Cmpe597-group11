...
python src/tasks/caption_classification/train/extract_features.py \
    --device $DEVICE \
...
python src/tasks/caption_classification/train/caption_type.py \
    --epochs $EPOCHS \
    --feature_dir $FEATURE_DIR \
    --device $DEVICE \
    --output_dir outputs/caption_classification/train/
